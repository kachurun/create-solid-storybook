...
// SolidJS logo SVG from Wikimedia Commons (https://commons.wikimedia.org/wiki/File:Logo_SolidJS.svg)
const SolidLogo = () => {
    ...
    const handleClick = () => {
        setRotating(true);
        setTimeout(() => setRotating(false), 1000); // 1s for 1 barrel roll
    };
    ...
    return (
        <div
            ...
            title="Click to barrel roll!"
        >
            <svg viewBox="0 0 166 155.3">
                <defs>
...
const meta = {
    title: 'Example/SolidLogo',
    component: SolidLogo,
};

type Story = { render: () => any };

export const SolidLogoStory: Story = {
    render: () => <SolidLogo />,
};
